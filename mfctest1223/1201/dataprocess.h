...
private:
    ...
    quint8 overload_judge(double weight , double span );
    ...
    //20141118
    private:
        //bool  readMomentData(quint32 *&spanArray, quint32 *&weightArray);
         void readMomentData();
         int   binSearch(quint32 spanArray [] ,int arrayLen, double key);
    private:
        QFile *file;   //用于操作 力矩表文件

        quint32 *spanArray;
        bool readTableFlag;

        double *table_weight_double;
        int tableLen;
