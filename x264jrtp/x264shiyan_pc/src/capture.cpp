...
#include "x264.h"
 ...
 io_method io = IO_METHOD_MMAP;  // IO---method use mmap
 int      fd  = -1;  
...
void openFiles()
{
 ...
 int read_frame(void) {  
   ...
   // FILE *tmpFP264 = fopen("softEncodeH264.h264","ab"); 
    ...
    case IO_METHOD_MMAP:  
        ...
        // timeuse/=1000000;
        // printf("picture getting--->--xioctl(fd, VIDIOC_DQBUF, &buf)---->---  Used Time( uSecond ):%f\n",timeuse);
...
//-->->--YUV420----------------------------------------------------------------------------
     ...
     // @ FANAN--002 
        ...
        // timeuse/=1000000;
        // printf("picture ----->---->----YUV422To420x264---->--->--- Used Time( uSecond ):%f\n",timeuse);         
...
//------------------------------------------------------------------------------------
        ...
        // tpend.tv_usec-tpstart.tv_usec;
        // timeuse/=1000000;
        // printf("picture -->---->---x264_encoder_encode----->--->--- Used Time( uSecond ):%f\n",timeuse);
        ...
        //printf(" x264_encoder_encode --encoded--bytesNALS-->> %d---nnal-->> %d --  \n",bytesNALS, nnal );
        ...
        for(nal=nals; nal<nals+nnal; nal++)
        {
            ...
            // @ 0506 FANAN02--SEND refuse to use SendH264Nalu(nal->p_payload,nal->i_payload);   too much MEMcpy usage
 ...
 //       rtpSend(tmpH264path);
        ...
        // tpend.tv_usec-tpstart.tv_usec;
        // timeuse/=1000000;
        // printf("picture -->---->---jrtpsend----->--->--- Used Time( uSecond ):%f\n",timeuse);
